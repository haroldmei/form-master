...
<div class="sv-form-container">
						Please provide the address of the applicant's permanent home below. It may be where the applicant currently lives, or it may be the applicant's family’s address if they are temporarily living somewhere else. All international applicants are required to have a permanent home address outside of Australia. Mandatory fields are marked with an asterisk (*).<br><br>
						<div class="sv-form-horizontal">
							<div class="sv-form-group">
								<label for="IPR_CODC" class="sv-col-md-3 sv-control-label">Country *</label>
								<div class="sv-col-md-4">
									<select id="IPR_CODC" name="IPR_CODC" class="" style="display: none;">
									...
									</select><div class="chosen-container chosen-container-single" title="" id="IPR_CODC_chosen" tabindex="-1" style="width: 100%;"><a class="chosen-single">
  <span id="IPR_CODC_chosenspan">-- Select --</span>
  <div><b></b></div>
</a>
<div class="chosen-drop">
  <div class="chosen-search">
    <input class="chosen-search-input" type="text" autocomplete="off" title="-- Select --" aria-owns="IPR_CODC_ul" tabindex="0" aria-autocomplete="list" aria-label="Country * search">
  </div>
  <ul class="chosen-results" role="listbox" tabindex="-1" aria-expanded="false" id="IPR_CODC_ul" aria-busy="true" aria-label="Country * options"></ul>
</div></div>
									<script>
										// Set the initial value of IPQ_APONLNID
										$("#IPR_CODC").val("");
										sits_chosen_widget("#IPR_CODC",{});
										$('#IPR_CODC').change(check_IPR_CODC);
									</script>
									<!-- Hidden input which is written back to IPQ CODC and is kept synced with IPR_CODC -->
									<input id="IPQ_CODC" name="IPQ_CODC" type="hidden" value="">
								</div>
							</div>
							<div class="sv-form-group" id="section0h" style="display:none">
							</div>
							<div class="sv-form-group">
								<label for="IPR_HAD1" class="sv-col-md-3 sv-control-label">Address line 1 *</label>
								<div class="sv-col-md-4">
									<input name="IPR_HAD1" id="IPR_HAD1" class="sv-form-control" type="text" maxlength="50" value="">
								</div>
							</div>
							<div class="sv-form-group">
								<label for="IPR_HAD2" class="sv-col-md-3 sv-control-label">Address line 2</label>
								<div class="sv-col-md-4">
									<input name="IPR_HAD2" id="IPR_HAD2" class="sv-form-control" type="text" maxlength="50" value="">
								</div>
							</div>
							<div class="sv-form-group" id="homeAddress3">
								<label for="IPR_HAD3" class="sv-col-md-3 sv-control-label"><span id="IPR_HAD3_label">Address line 3</span></label>
								<div class="sv-col-md-4">
									<input name="IPR_HAD3" id="IPR_HAD3" class="sv-form-control" type="text" maxlength="50" value="">
								</div>
							</div>
							<div class="sv-form-group">
								<label for="IPR_HAD4" class="sv-col-md-3 sv-control-label"><span id="IPR_HAD4_label">Town, City or Suburb *</span></label>
								<div class="sv-col-md-4">
									<input name="IPR_HAD4" id="IPR_HAD4" class="sv-form-control" type="text" maxlength="50" value="">
								</div>
							</div>
							<div class="sv-form-group" id="homeAddress5">
								<label for="IPR_HAD5" class="sv-col-md-3 sv-control-label"><span id="IPR_HAD5_label">State, Territory, Province or County *</span></label>
								<div class="sv-col-md-4" id="homeAddress5Input"><input id="IPR_HAD5" class="sv-form-control" type="text" name="IPR_HAD5" value="" maxlength="50"></div>
							</div>
							<div class="sv-form-group">
								<label for="IPR_HAPC" class="sv-col-md-3 sv-control-label">Postal/ZIP code *</label>
								<div class="sv-col-md-4">
									<input name="IPR_HAPC" id="IPR_HAPC" class="sv-form-control" type="text" maxlength="15" value="">
								</div>
							</div>
						</div>
					</div>
...
class PersonalInfoAddressPerm:
    ...
    def run(self):
        ...
        # Country selection for permanent address (required field marked with *)
        country = personal_info.get('Country', 'China (Excludes SARS and Taiwan)')
        select_option_by_id(driver, "IPR_CODC", country)
        ...
        set_value_by_id(driver, "IPR_HAD1", line1)
